initial begin
    `ifndef CARAVAN
    `ifdef ARM
    $sdf_annotate({`CARAVEL_ROOT,"/signoff/swift_caravel/primetime/sdf/",`SDF_POSTFIX,"/swift_caravel.",`CORNER ,".sdf"}, uut,,{`MAIN_PATH,"/sim/",`TAG,"/",`FTESTNAME,"/caravel_sdf.log"},`ifdef MAX_SDF "MAXIMUM" `else "MINIMUM" `endif ); 
    `else
