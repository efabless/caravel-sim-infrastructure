...
void main(){
    ...
    if (sky){
        ...
        if (reg_mprj_io_0 != 0x3FF){

            reg_debug_2 =reg_mprj_io_0;
            reg_debug_1 =0x1;

        }
        if (reg_mprj_io_1 != 0x3FF)
            reg_debug_1 =0x2;
        if (reg_mprj_io_2   != 0x3FF)
            reg_debug_1 =0x3;
        if (reg_mprj_io_3   != 0x3FF)
            reg_debug_1 =0x4;
        if (reg_mprj_io_4   != 0x3FF)
            reg_debug_1 =0x5;
        if (reg_mprj_io_5   != 0x3FF)
            reg_debug_1 =0x6;
        if (reg_mprj_io_6   != 0x3FF)
            reg_debug_1 =0x7;
        if (reg_mprj_io_7   != 0x3FF)
            reg_debug_1 =0x8;
        if (reg_mprj_io_8   != 0x3FF)
            reg_debug_1 =0x9;
        if (reg_mprj_io_9   != 0x3FF)
            reg_debug_1 =0xa;
        if (reg_mprj_io_10  != 0x3FF)
            reg_debug_1 =0xb;
        if (reg_mprj_io_11  != 0x3FF)
            reg_debug_1 =0xc;
        if (reg_mprj_io_12  != 0x3FF)
            reg_debug_1 =0xd;
        if (reg_mprj_io_13  != 0x3FF)
            reg_debug_1 =0xe;
        if (reg_mprj_io_14  != 0x3FF)
            reg_debug_1 =0xf;
        if (reg_mprj_io_15  != 0x3FF)
            reg_debug_1 =0x10;
        if (reg_mprj_io_16  != 0x3FF)
            reg_debug_1 =0x11;
        if (reg_mprj_io_17  != 0x3FF)
            reg_debug_1 =0x12;
        if (reg_mprj_io_18  != 0x3FF)
            reg_debug_1 =0x13;
        if (reg_mprj_io_19  != 0x3FF)
            reg_debug_1 =0x14;
        if (reg_mprj_io_20  != 0x3FF)
            reg_debug_1 =0x15;
        if (reg_mprj_io_21  != 0x3FF)
            reg_debug_1 =0x16;
        if (reg_mprj_io_22  != 0x3FF)
            reg_debug_1 =0x17;
        if (reg_mprj_io_23  != 0x3FF)
            reg_debug_1 =0x18;
        if (reg_mprj_io_24  != 0x3FF)
            reg_debug_1 =0x19;
        if (reg_mprj_io_25  != 0x3FF)
            reg_debug_1 =0x1a;
        if (reg_mprj_io_26  != 0x3FF)
            reg_debug_1 =0x1b;
        if (reg_mprj_io_27  != 0x3FF)
            reg_debug_1 =0x1c;
        if (reg_mprj_io_28  != 0x3FF)
            reg_debug_1 =0x1d;
        if (reg_mprj_io_29  != 0x3FF)
            reg_debug_1 =0x1e;
        if (reg_mprj_io_30  != 0x3FF)
            reg_debug_1 =0x1f;
        if (reg_mprj_io_31  != 0x3FF)
            reg_debug_1 =0x20;
        if (reg_mprj_io_32  != 0x3FF)
            reg_debug_1 =0x21;
        if (reg_mprj_io_33  != 0x3FF)
            reg_debug_1 =0x22;
        if (reg_mprj_io_34  != 0x3FF)
            reg_debug_1 =0x23;
        if (reg_mprj_io_35  != 0x3FF)
            reg_debug_1 =0x24;
        if (reg_mprj_io_36  != 0x3FF)
            reg_debug_1 =0x25;
        if (reg_mprj_io_37  != 0x3FF)
            reg_debug_1 =0x26;
    }
