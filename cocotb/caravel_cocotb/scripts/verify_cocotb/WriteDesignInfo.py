...
# true when openframe are simulated instead of caravel
openframe: false

# optional email address to send the results to
emailto: [None]

# optional is user project
is_user_project: true

"""
EnvironmentPaths = namedtuple(
    "EnvironmentPaths", "CARAVEL_ROOT PDK_ROOT PDK USER_PROJECT_ROOT"
)
...
class WriteDesignInfo:
    def __init__(
        ...
        self.update_yaml_args(env_paths, clk, is_caravan, is_openframe, Emailto, is_user_project)
        self.write_yaml_f(cocotb_path)

    def update_yaml_args(
        self, env_paths: EnvironmentPaths, clk, is_caravan=False, is_openframe=False, Emailto=None, is_user_project=True
    ):
        ...
        self.code["openframe"] = is_openframe
        self.code["emailto"] = [None] if Emailto is None else Emailto
        self.code["is_user_project"] = is_user_project
