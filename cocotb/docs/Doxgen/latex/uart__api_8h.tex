...
{\em is\+\_\+enable} & when 1(true) uart TX enable, 0 (false) uart TX disable\\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
Some caravel C\+PU enable and disable uart TX and RX together 
\end{DoxyNote}
...
Return the first A\+S\+C\+II symbol of the U\+A\+RT recieved queue
...
Pop the first A\+S\+C\+II symbol of the U\+A\+RT recieved queue
...
\begin{DoxyParams}{Parameters}
{\em is\+\_\+enable} & when 1(true) uart RX enable, 0 (false) uart RX disable\\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
Some caravel C\+PU enable and disable uart TX and RX together 
