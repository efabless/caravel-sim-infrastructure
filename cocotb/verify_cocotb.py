...
parser.add_argument('-zip_passed',action='store_true', help='zip the waves and logs of passed tests. by default if the run has more than 7 tests pass tests results would be zipped automatically')
